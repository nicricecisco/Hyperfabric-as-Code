...
template_single_portion_of_api_path = '''
/KEY_A_PARENT_PLURAL/{{KEY_A_PARENT_ID_CAMEL}}
'''

template_get_all_call = '''
def get_fabric_KEY_LOWER_SNAKE_PLURAL(KEY_DATA_OBJ):
    """
    ...
    """
    params = {key: KEY_DATA_OBJ["KEY_LOWER_SNAKE_PLURAL"][key] for key in ["candidate", "includeMetadata"] if key in KEY_DATA_OBJ.get("KEY_LOWER_SNAKE_PLURAL", {})}
...
template_post_call = '''
def add_fabric_KEY_LOWER_SNAKE_PLURAL(KEY_DATA_OBJ):
    """
...
def get_fabric_KEY_LOWER_SNAKE_PLURAL(KEY_DATA_OBJ):
    ...
    response = _make_get_request(headers, f"{BASE_URL}KEY_PATH_ROOT_TO_KEY_OBJ", params=params)
    return response
'''

template_put_call = '''
def update_fabric_KEY_LOWER_SNAKE_PLURAL(KEY_DATA_OBJ):
    """
    ...
    response = _make_put_request(headers, f"{BASE_URL}KEY_PATH_ROOT_TO_KEY_OBJ", payload=payload)
    return response
'''

template_delete_call = '''
def delete_fabric_KEY_LOWER_SNAKE_PLURAL(KEY_DATA_OBJ):
   """
   ...
   INSERT_TEMPLATE_EXTRACT_ID
   KEY_CAMEL_SINGULARId = KEY_DATA_OBJ["KEY_LOWER_SNAKE_PLURAL"]["name"]
   response = _make_delete_request(headers, f"{BASE_URL}KEY_PATH_ROOT_TO_KEY_OBJ")
   return response
'''